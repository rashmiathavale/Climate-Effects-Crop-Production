...
st.markdown("<h1 style='text-align: center;'>Climate Effects on Crop Production</h1>", unsafe_allow_html=True)
st.markdown("""---""")
...
if crop == "Oats":
    st.markdown("<p style='text-align: center;'>Major oat producing states are Iowa, Minnesota and Wisconsin. Oats grow best in cool, moist climates, with the optimum temperature for growth being between 20°C and 21°C (68-70°F). The plants will thrive in well drained soils but are adapted to grow in many soil types, requiring a pH between 5.5 and 7.0.</p>", unsafe_allow_html=True)

if crop == "Soybeans":
    st.markdown("<p style='text-align: center;'>More than 80 percent of soybeans are cultivated in the upper Midwest. Soybeans are a temperate leguminous plant with an ideal daytime temperature of 85°F. When air temperatures exceed 85°F, soybeans can experience heat stress regardless of reproductive stage. When soybeans experience heat stress, yield reductions can begin to occur, especially when soil moisture is limiting.</p>", unsafe_allow_html=True)

if crop == "Wheat":
    st.markdown("<p style='text-align: center;'>Minnesota is a major wheat-producing state. High temperature stress is a major environmental factor that limits yield in wheat. Every 1°C increase above a mean temperature of 23°C decreases wheat yield by around 10 percent. More than 40 percent of total wheat area in the world is affected by high temperature stress.</p>", unsafe_allow_html=True)
...
st.markdown("""---""")
st.markdown("<h1 style='text-align: center;'>County</h1>", unsafe_allow_html=True)
...
st.markdown("""---""")
st.markdown("<h1 style='text-align: center;'>State</h1>", unsafe_allow_html=True)
